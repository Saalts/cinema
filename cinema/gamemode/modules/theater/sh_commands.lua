CreateConVar( "cinema_url", "http://saalts.github.io/cinema/", FCVAR_REPLICATED, "Cinema url to load on theater screens." )
CreateConVar( "cinema_request_url", "http://saalts.github.io/cinema/search.html", FCVAR_REPLICATED, "Cinema url to load in request window by default." )
CreateConVar( "cinema_help_url", "http://saalts.github.io/cinema/help.html", FCVAR_REPLICATED, "Url to load when f1 is pressed." )
